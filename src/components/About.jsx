        ...
        <div id='about'>
            <div className='con_left'>
                <div className='con_content'>
                    <h1 style={{ marginBottom: "2rem", textAlign: "center" }}>About myself</h1>
                    <ul >
                        <li>👨‍💻 Learning and working since 2021 🚀</li>
                        <li>🔭 I’m currently learning in FPT University HCM.</li>
                        <li>❓ Ask me about anything.</li>
                        <li>⚡ Fun fact: I'm very friendly.</li>
                    </ul>
                </div>
            </div>
            <div className='con_middle'>
                <div className='con_content2'>
